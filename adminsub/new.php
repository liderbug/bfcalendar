...
<tr><td>Location</td><td><input type=text name=loc size=40 value=Club> * Club, Pavilion, C&P, N40</td></tr>
<tr><td>Type</td><td><input type=text name=type size=40 value=Paid> * Paid, Discount, Free, </td></tr>
<!--tr><td>ModDate</td><td>
...
$list = array ('date', 'dur', 'end', 'rep', 'name', 'desc', 'contact', 'loc', 'type', 'moddate', 'who','cat');
...
$q2i = "insert into cal_misc values ($id1[0], '$desc', '$contact', '$loc', '$type', $moddate, '$who[0]');";
